...
│  YOUR POSITIONS                                                         │
│  ┌─────────────────────────────────────────────────────────────────┐   │
│  │  No open positions in BTC-USDC                                  │   │
│  └─────────────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────────────┘
```

### PAGE 3: DEPOSIT (LI.FI)

**Route:** `/deposit`

```
┌─────────────────────────────────────────────────────────────────────────┐
│  ◈ BLACK AND YELLOW                      DEPOSIT                        │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│     ┌───────────────────────────────────────────────────────────┐      │
│     │                                                           │      │
...
│     │   │  [ARBITRUM ▼]          [ETH ▼]                  │    │      │
│     │   │                                                 │    │      │
│     │   │  Amount: [2.5________]  Balance: 3.2 ETH       │    │      │
│     │   └─────────────────────────────────────────────────┘    │      │
│     │                                                           │      │
│     │                     ▼  LI.FI ROUTE  ▼                     │      │
│     │                     Arbitrum → Base                       │      │
│     │                        ~45 seconds                        │      │
│     │                                                           │      │
│     │   TO (BLACK AND YELLOW on BASE)                           │      │
│     │   ┌─────────────────────────────────────────────────┐    │      │
│     │   │  Trading Balance                                │    │      │
│     │   │                                                 │    │      │
│     │   │  Receiving: ~$8,642.50 USDC                    │    │      │
│     │   └─────────────────────────────────────────────────┘    │      │
│     │                                                           │      │
│     │   ┌─────────────────────────────────────────────────┐    │      │
│     │   │              💛 DEPOSIT NOW                     │    │      │
...
@keyframes match-glow {
  ...
  70% {
    box-shadow: 0 0 0 20px hsl(45 100% 50% / 0);
  }
  100% {
...
```tsx
// Button with yellow glow on hover
<Button className="hover:shadow-[0_0_20px_hsl(45_100%_50%_/_0.4)] transition-shadow">

// Card with border glow
<Card className="hover:border-primary/50 hover:shadow-[0_0_10px_hsl(45_100%_50%_/_0.2)] transition-all">
...
| Primary | `#FFD700` | Yellow accents, CTAs |
| Accent | `#FFDF33` | Bright highlights |
| Text Primary | `#F5F5F0` | Main text |
| Text Secondary | `#808080` | Labels, hints |
| Profit | `#22C55E` | Positive PnL |
| Loss | `#EF4444` | Negative PnL |
| Hidden | `#8B5CF6` | Privacy indicators |

---

**BLACK AND YELLOW** - Private Perpetuals Exchange
*"Your orders are hidden from everyone — including us."*
